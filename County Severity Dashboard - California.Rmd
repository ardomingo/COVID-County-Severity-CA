...
#Download file from GH repo
# shape_github <- "https://github.com/ardomingo/COVID-County-Severity-CA/blob/main/CA_Counties_TIGER2016.shp?raw=true"
#  

# 
# library(curl)
# github_test <- curl("https://github.com/ardomingo/COVID-County-Severity-CA/blob/main/CA_Counties_TIGER2016.shp")
# 
# 
# CA_areas1 <- st_read(readLines(github_test)) %>%
#   st_transform("+proj=longlat +datum=WGS84")

# CA_areas1 <- st_read(github_test) %>%
#   st_transform("+proj=longlat +datum=WGS84")
...
# CA_areas1 <- readOGR(dsn = path.expand("~CA_Shapes/CA_Counties"), layer = "CA_Counties_TIGER2016" )
# 
# 
# CA_areas1 <- st_read("~CA_Shapes/CA_Counties.CA_Counties_TIGER2016.shp") %>% 
#   st_transform("+proj=longlat +datum=WGS84")
